...
const stickerDescriptions: Record<string, string[]> = {
    layla: [
        ...
        'Layla lehnt entspannt an einem Felsen und blickt in den Himmel — natuerlich und vertraeumt.',
        'Layla sitzt verfuehrerisch auf Kuestenfelsen und blickt direkt in die Kamera.',
        'Layla am Strand — Ruecken zur Kamera, Arm im Nacken, Bikini, Meerblick.',
    ...
    christine: [
        'Christine laechelt direkt in die Kamera — ein warmes, einladendes Portrait.',
        'Christine sitzt auf einer Steinmauer im Sommerkleid — entspannt in der Natur.',
        'Christine am Strand, Ruecken zur Kamera — blond, Meer, Sommergefuehl.',
        'Christine posiert mit gelbem Handtuch — frisch und natuerlich.',
        'Christine sitzt entspannt auf dem Sofa in weissem Oberteil — gemuetlich und nahbar.',
        'Christine im Spiegel in weisser Spitze-Dessous — elegant und feminin.',
        ...
        'Christine in der Badewanne mit Seifenschaum — entspannt und vertraeumt.',
        'Christine im Bikini mit Sonnenbrille, laechelnd — Sommer, Sonne, gute Laune.',
        'Christine in weisser Spitze-Unterwaesche auf einem Stuhl — elegant und sinnlich.',
        'Christine im Leoparden-Print auf weisser Bank — mutig und individuell.',
    ],
};
